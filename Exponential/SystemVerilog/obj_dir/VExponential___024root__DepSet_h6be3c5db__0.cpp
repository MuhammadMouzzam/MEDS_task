...
VL_INLINE_OPT void VExponential___024root___ico_sequent__TOP__0(VExponential___024root* vlSelf) {
    ...
    vlSymsp->TOP____024unit.exp__Vstatic__result = 
        (0.0 + (([&]() {
                    ...
                    while (VL_LTS_III(32, vlSymsp->TOP____024unit.power__Vstatic__i, vlSelf->__Vfunc_power__1__pow)) {
                ...
                / ([&]() {
                    ...
                    while (VL_LTES_III(32, vlSymsp->TOP____024unit.factorial__Vstatic__i, vlSelf->__Vfunc_factorial__2__x)) {
