...
void VExponential___024root__trace_chg_0_sub_0(VExponential___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgDouble(oldp+0,(vlSymsp->TOP____024unit.factorial__Vstatic__fact));
        bufp->chgIData(oldp+2,(vlSymsp->TOP____024unit.factorial__Vstatic__i),32);
        bufp->chgDouble(oldp+3,(vlSymsp->TOP____024unit.exp__Vstatic__result));
        bufp->chgIData(oldp+5,(vlSymsp->TOP____024unit.power__Vstatic__i),32);
        bufp->chgDouble(oldp+6,(vlSymsp->TOP____024unit.power__Vstatic__result));
    }
