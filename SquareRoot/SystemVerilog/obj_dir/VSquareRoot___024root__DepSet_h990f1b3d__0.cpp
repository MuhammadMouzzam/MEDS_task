...
void VSquareRoot___024root___eval_triggers__ico(VSquareRoot___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSquareRoot___024root___eval_triggers__ico\n"); );
    // Body
...
VL_INLINE_OPT void VSquareRoot___024root___ico_sequent__TOP__0(VSquareRoot___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSquareRoot__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSquareRoot___024root___ico_sequent__TOP__0\n"); );
    // Init
...
void VSquareRoot___024root___eval_triggers__act(VSquareRoot___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSquareRoot__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSquareRoot___024root___eval_triggers__act\n"); );
    // Body
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
